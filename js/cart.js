...
function start(){
    ...
    .catch(error => {
    console.log("Seens like something gone wrong", error)
    });
}
...
function adicionarAoCarrinho(nome, imgLink, descricao, preco){
    carrinho.push({ //monta um objeto no carrinho
        "nome" : nome,
        "imgLink" : imgLink,
        "descricao" : descricao,
        ...
        carrinhoHTML.innerHTML += 
            ...
            >
                <div class='d-flex flex-row align-items-center'>
                    ...
                    <div class='d-flex flex-colum pl-md-4 pl-1'>
...
function addItem(item){
    ...
    produto.quantidade ++; //quantidade da linha 33
...
function removeProduto(item){
    ...
    if(confirm("Voce quer mesmo remover do carrinho?")){
        carrinho[item].quantidade = 0;
        atualizaSubTotal();
        carrinhoHTML.removeChild(produto) //remove da pagina o bloco desse produto
    }
}